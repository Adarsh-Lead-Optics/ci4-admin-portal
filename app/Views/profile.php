...
<!--  --> 
        <div class="contanier m-auto w-75 pt-5 mb-5">
                        ...
                        <div class="card-body p-1-9 p-sm-2-3 p-md-6 p-lg-7">
                            <div class="row align-items-center">
                                <div class="col-lg-4 mb-4 mb-lg-0">
                                    <img class="w-75" src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="Default Image">
                                </div>
                                <div class="col-lg-6 px-xl-10">
                                    <div class="bg-secondary d-lg-inline-block py-1-9 px-1-9 px-sm-6 mb-1-9 rounded">
                                        <h3 class="h2 text-white mb-0"><?= $userData['name']; ?></h3> 
                                    </div>
                                    <ul class="list-unstyled mb-1-9">
                                        <li class="mb-2 mb-xl-3 display-28">
                                            <span class="display-26 text-secondary me-2 font-weight-600">Email Id :</span>
                                             <?= $userData['email']; ?>
                                        </li>
                                          <li class="mb-2 mb-xl-3 display-28">
                                            <span class="display-26 text-secondary me-2 font-weight-600">Mobile No :</span>
                                             <?php if(isset($userData['mobile']) ? $userData['mobile']: 'N/A'): 
