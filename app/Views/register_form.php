...
<body>  
    ...
    <section>
        ...
        <div class="contanier pt-5 pb-5"> 
            ...
            <div class="col-md-12">
                <label for="nameId" class="form-label">Name <sup class="star-require">*</sup></label>
                <?php echo form_input(['id' => 'nameId', 'type' => 'text', 'name' => 'name', 'class' => 'my-input-all form-control', 'value' => '']); ?>
                <div class="error" id="nameError// "></div>
            </div>
            <div class="col-12">
                <label for="emailId" class="form-label">Email <sup class="star-require">*</sup></label>
                <?php echo form_input(['id' => 'emailId', 'type' => 'text', 'name' => 'email', 'class' => 'my-input-all form-control', 'value' => '']) ?>
                <!-- <input type="email" name="email" class="my-input-all form-control" id="emailId"> -->
                <div class="error" id="emailError"></div>
            </div>
            <div class="col-12">
                <label for="mobileId" class="form-label">Mobile <sup class="star-require">*</sup></label>
                <?php echo form_input(['id' => 'mobileId', 'type' => 'text', 'name' => 'mobile', 'class' => 'my-input-all form-control', 'value' => '']) ?>
                <!-- <input type="text" name="mobile" class="my-input-all form-control" id="mobileId"> -->
                <div class="error" id="mobileError"></div>
            </div>
            <div class="col-md-12">
                <label for="passid" class="form-label">Password <sup class="star-require">*</sup></label>
                <?php echo form_input(['id' => 'passId', 'type' => 'password', 'name' => 'password', 'class' => 'my-input-all form-control', 'value' => '']) ?>
                <!-- <input type="password" name="password" class="my-input-all form-control" id="passid"> -->
                <div class="error" id="passwordError"></div>
            </div>
            <div class="col-12">
                <!-- <input type="submit" name="submit" class="btn btn-primary" value="Sign in"> -->
                <?php echo form_input(['register-btn', 'type' => 'submit', 'name' => 'submit', 'class' => 'btn btn-success', 'value' => 'Register Now']) ?>
            </div>
            <!-- </form> -->
            <?php form_close(); ?>
        </div>
    ...
    <script src="/ci4-all/admin-portal/public/script/validate.js"></script>
